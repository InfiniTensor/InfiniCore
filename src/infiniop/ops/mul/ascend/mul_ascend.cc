...
infiniStatus_t Descriptor::create(
    ...
    auto status = device::ascend::validateAclnnElementwise(output_desc, input_descs, 2);
    ...
    opaque->op.tensors = {
        ...
        new aclnnTensorDescriptor(input_descs[1]),
