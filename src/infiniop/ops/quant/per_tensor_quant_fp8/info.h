...
class PerTensorQuantFp8Info {
private:
    PerTensorQuantFp8Info() = default;
...
public:
    ...
    static utils::Result<PerTensorQuantFp8Info> createPerTensorQuantFp8Info(
        ...
        return utils::Result<PerTensorQuantFp8Info>(PerTensorQuantFp8Info{
            dtype,
            packed_type,
