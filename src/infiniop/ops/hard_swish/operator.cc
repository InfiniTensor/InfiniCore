...
#include "cpu/hard_swish_cpu.h"
#endif
#if defined(ENABLE_NVIDIA_API) || defined(ENABLE_ILUVATAR_API)
#include "nvidia/hard_swish_nvidia.cuh"
#endif
#ifdef ENABLE_METAX_API
#include "metax/hard_swish_metax.h"
#endif
...
#define CREATE(CASE, NAMESPACE)                                            \
    case CASE:                                                             \
        return op::hard_swish::NAMESPACE::Descriptor::create(                     \
            handle,                                                        \
            reinterpret_cast<op::hard_swish::NAMESPACE::Descriptor **>(desc_ptr), \
            output,                                                        \
            {input})
...
#define CALCULATE(CASE, NAMESPACE)                                            \
    case CASE:                                                                \
        return reinterpret_cast<const op::hard_swish::NAMESPACE::Descriptor *>(desc) \
...
#define DELETE(CASE, NAMESPACE)                                                \
    case CASE:                                                                 \
        delete reinterpret_cast<const op::hard_swish::NAMESPACE::Descriptor *>(desc); \
        return INFINI_STATUS_SUCCESS
