...
#define GET(CASE, NAMESPACE)                                                                        \
    case CASE:                                                                                      \
        *size = reinterpret_cast<op::silu_and_mul::NAMESPACE::Descriptor *>(desc)->workspaceSize(); \
...
#define CALCULATE(CASE, NAMESPACE)                                                           \
    case CASE:                                                                               \
        return reinterpret_cast<op::silu_and_mul::NAMESPACE::Descriptor *>(desc)->calculate( \
...
#define DESTROY(CASE, NAMESPACE)                                                  \
    case CASE:                                                                    \
        delete reinterpret_cast<op::silu_and_mul::NAMESPACE::Descriptor *>(desc); \
        return INFINI_STATUS_SUCCESS;
