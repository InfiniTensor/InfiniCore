#ifndef __VDOT_NVIDIA_CUH__
#define __VDOT_NVIDIA_CUH__
...
public:
  Descriptor(infiniDtype_t in_dtype, infiniDtype_t out_dtype, size_t length,
             ptrdiff_t a_stride, ptrdiff_t b_stride,
      ...
      : InfiniopDescriptor{device_type, device_id}, _in_dtype(in_dtype),
        ...
        _b_stride(b_stride), _internal(internal) {}
