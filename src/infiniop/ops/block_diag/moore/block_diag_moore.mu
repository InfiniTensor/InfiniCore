...
infiniStatus_t Descriptor::calculate(
    ...
    ptrdiff_t *d_input_stride0, *d_input_stride1;
    const void **d_inputs;
    ...
    CHECK_MOORE(musaMalloc((void **)&d_input_stride0, num_inputs * sizeof(ptrdiff_t)));
    CHECK_MOORE(musaMalloc((void **)&d_input_stride1, num_inputs * sizeof(ptrdiff_t)));
    ...
    for (size_t i = 0; i < num_inputs; ++i) {
        ...
        input_stride0[i] = static_cast<ptrdiff_t>(input_cols[i]);
        input_stride1[i] = 1;
    }
    ...
    ptrdiff_t output_stride0 = static_cast<ptrdiff_t>(output_shape[1]);
    ptrdiff_t output_stride1 = 1;
    ...
    default:
        ...
        CHECK_MOORE(musaFree(d_input_stride0));
        CHECK_MOORE(musaFree(d_input_stride1));
