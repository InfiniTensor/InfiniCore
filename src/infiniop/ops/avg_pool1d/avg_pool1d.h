...
// =======================================================================
// 1. Descriptor 定义宏 (用于各后端快速生成 Descriptor 类)
// =======================================================================
...
public:
    ...
    static utils::Result<AvgPool1dInfo> createAvgPool1dInfo(
        ...
        // 5. 输出宽度校验 (核心逻辑)
        // L_out = (L_in + 2*pad - kernel) / stride + 1
        size_t padded_len = in_width + 2 * padding;
        
        // 确保 kernel_size 不会比 padded_len 还大 (避免 size_t 下溢)
