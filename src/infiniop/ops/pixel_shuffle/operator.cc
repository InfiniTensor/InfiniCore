...
__C infiniStatus_t infiniopGetPixelShuffleWorkspaceSize(
...
#define CALCULATE(CASE, NAMESPACE)                                                               \
    case CASE:                                                                                   \
        return reinterpret_cast<const op::pixel_shuffle::NAMESPACE::Descriptor *>(desc)->calculate( \
            workspace,                                                                           \
            workspace_size,                                                                      \
            output,                                                                              \
            input,                                                                               \
...
__C infiniStatus_t infiniopDestroyPixelShuffleDescriptor(
    infiniopPixelShuffleDescriptor_t desc) {
