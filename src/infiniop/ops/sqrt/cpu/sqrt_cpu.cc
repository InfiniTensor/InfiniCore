...
infiniStatus_t Descriptor::create(
    ...
    const auto &input_desc = input_descs.at(0);
    ...
    CREATE_ELEMENTWISE_CPU_DESCRIPTOR(handle, dtype, out_desc, input_descs);
...
infiniStatus_t Descriptor::calculate(
    ...
    case INFINI_DTYPE_BF16:
        return _device_info->calculate<SqrtOp, bf16_t>(_info, output, inputs, stream);
    ...
    case INFINI_DTYPE_F64:
        return _device_info->calculate<SqrtOp, double>(_info, output, inputs, stream);
    default:
