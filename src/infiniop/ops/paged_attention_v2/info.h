#ifndef __PAGED_ATTENTION_V2_INFO_H__
#define __PAGED_ATTENTION_V2_INFO_H__
...
namespace op::paged_attention_v2 {

class PagedAttentionV2Info {
    PagedAttentionV2Info() = default;
...
public:
    ...
    static utils::Result<PagedAttentionV2Info> create(
        ...
        return utils::Result<PagedAttentionV2Info>(PagedAttentionV2Info{
            dtype,
            block_tables_dt,
            scale,
            num_seqs,
...
#endif // __PAGED_ATTENTION_V2_INFO_H__
