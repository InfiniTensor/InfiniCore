...
#include "nvidia/paged_attention_v2_nvidia.cuh"
#endif
#if defined(ENABLE_METAX_API)
#include "metax/paged_attention_v2_metax.cuh"
#endif
__C infiniStatus_t infiniopCreatePagedAttentionV2Descriptor(
    infiniopHandle_t handle,
    infiniopPagedAttentionV2Descriptor_t *desc_ptr,
...
#define CREATE(CASE, NAMESPACE)                                                           \
    case CASE:                                                                            \
        return op::paged_attention_v2::NAMESPACE::Descriptor::create(                     \
            handle,                                                                       \
            reinterpret_cast<op::paged_attention_v2::NAMESPACE::Descriptor **>(desc_ptr), \
...
__C infiniStatus_t infiniopGetPagedAttentionV2WorkspaceSize(
    infiniopPagedAttentionV2Descriptor_t desc,
    size_t *size) {

#define GET(CASE, NAMESPACE)                                                                              \
    case CASE:                                                                                            \
        *size = reinterpret_cast<op::paged_attention_v2::NAMESPACE::Descriptor *>(desc)->workspaceSize(); \
...
__C infiniStatus_t infiniopPagedAttentionV2(
    infiniopPagedAttentionV2Descriptor_t desc,
    void *workspace,
...
__C infiniStatus_t infiniopDestroyPagedAttentionV2Descriptor(
    infiniopPagedAttentionV2Descriptor_t desc) {

#define DESTROY(CASE, NAMESPACE)                                                        \
    case CASE:                                                                          \
        delete reinterpret_cast<op::paged_attention_v2::NAMESPACE::Descriptor *>(desc); \
        return INFINI_STATUS_SUCCESS;
