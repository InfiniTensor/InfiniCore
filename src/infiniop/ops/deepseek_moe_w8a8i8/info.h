#ifndef __DEEPSEEK_MOE_W8A8I8_INFO_H__
#define __DEEPSEEK_MOE_W8A8I8_INFO_H__

#include "../../../utils.h"
#include "../../tensor.h"

namespace op::deepseek_moe_w8a8i8 {

class DeepseekMoeW8A8I8Info {
    DeepseekMoeW8A8I8Info() = default;
...
public:
    ...
    static utils::Result<DeepseekMoeW8A8I8Info> create(
        ...
        CHECK_OR_RETURN(
            out_desc != nullptr && hidden_desc != nullptr && topk_indices_desc != nullptr && topk_weights_desc != nullptr,
        ...
        return utils::Result<DeepseekMoeW8A8I8Info>(DeepseekMoeW8A8I8Info{
            dtype,
            hidden_shape[0],
            hidden_shape[1],
            indices_shape[1],
