...
#define CREATE(CASE, NAMESPACE)                                                                \
    case CASE:                                                                                 \
        return op::paged_attention_prefill::NAMESPACE::Descriptor::create(                     \
            ...
            out_desc, q_desc, k_cache_desc, v_cache_desc, block_tables_desc, seq_lens_desc, seq_offsets_desc, cache_lens_desc, alibi_opt, scale);
...
#define CALCULATE(CASE, NAMESPACE)                                                                      \
    case CASE:                                                                                          \
        return reinterpret_cast<op::paged_attention_prefill::NAMESPACE::Descriptor *>(desc)->calculate( \
            ...
            seq_lens, seq_offsets, cache_lens, alibi_slopes, stream);
