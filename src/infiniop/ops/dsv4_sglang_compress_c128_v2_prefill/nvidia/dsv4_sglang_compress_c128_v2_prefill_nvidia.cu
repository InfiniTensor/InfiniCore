#include "../../../handle.h"
#include "dsv4_sglang_compress_c128_v2_prefill_nvidia.cuh"
...
constexpr const char *kSymbol = "_Z40sglang_compress_c128_v2_prefill_bf16_512N3tvm3ffi10TensorViewES1_S1_S1_S1_S1_";
...
tvm::ffi::TensorView makeView(const void *data, const op::dsv4_sglang_compress_c128_v2_prefill::TensorInfo &info, int dev, DLTensor &t) {
