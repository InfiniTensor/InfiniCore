...
#include "reshape_and_cache_metax_kernels.cuh"
#include "reshape_and_cache_metax.cuh"
...
//     op::reshape_and_cache::metax::reshape_and_cache_kernel<KV_T, CACHE_T, KV_DTYPE> \
//         <<<grid, block, 0, stream>>>(                                              \
...
infiniStatus_t Descriptor::calculate(
    ...
    hcStream_t stream = static_cast<hcStream_t>(stream_);
