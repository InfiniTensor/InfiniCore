#include "cosh_moore.h"

#include "../../../elementwise/moore/elementwise_moore.h"

#include "../cuda/kernel.cuh"

namespace op::cosh::moore {
...
infiniStatus_t Descriptor::calculate(
    ...
    case INFINI_DTYPE_BF16:
        return _device_info->calculate<256, cuda::CoshOp, cuda_bfloat16>(_info, workspace, output, inputs, stream);
    case INFINI_DTYPE_F32:
        return _device_info->calculate<256, cuda::CoshOp, float>(_info, workspace, output, inputs, stream);
    case INFINI_DTYPE_F64:
        return _device_info->calculate<256, cuda::CoshOp, double>(_info, workspace, output, inputs, stream);
    default:
