...
std::shared_ptr<infiniop_test::Result> Test::run(
    ...
    CHECK_OR(infiniopCreateLinearBackwardDescriptor(handle, &op_desc,
            grad_x->desc(),
            grad_w->desc(),
            (_attributes->bias_exist) ? grad_b->desc() : nullptr,
            grad_y->desc(),
            x->desc(),
            w->desc()
        ),
    ...
    CHECK_OR(infiniopLinearBackward(op_desc, workspace, workspace_size,
                    grad_x->data(),
                    grad_w->data(),
                    (_attributes->bias_exist) ? grad_b->data() : nullptr,
                    grad_y->data(),
                    x->data(),
                    w->data(),
                    nullptr),
...
std::string Test::toString() const {
    ...
    oss << "- grad_b: " << (_attributes->bias_exist ? _attributes->grad_b->info() : "null") << std::endl;
