...
inline Tensor py_infllmv2_varlen(Tensor q,
                                 Tensor k,
                                 Tensor v,
                                 Tensor cu_seqlens_q,
                                 Tensor cu_seqlens_k,
...
inline Tensor py_infllmv2_kvcache(Tensor q,
                                  Tensor k_cache,
                                  Tensor v_cache,
                                  Tensor cache_lens,
                                  float scale,
...
inline void bind_infllmv2_attention(py::module &m) {
    ...
    m.def(
        ...
        py::arg("window_size_left") = -1,
        py::arg("window_size_right") = -1,
        R"doc(Deprecated alias for infllmv2_attention_varlen.)doc");
    ...
    m.def(
        ...
        py::arg("window_size_left") = -1,
        py::arg("window_size_right") = -1,
        R"doc(Deprecated alias for infllmv2_attention_kvcache.)doc");
}
