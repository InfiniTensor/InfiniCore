...
void KVCaching::execute(Tensor k_cache,
                        ...
                        Tensor cache_ids) {
    INFINICORE_ASSERT_TENSORS_SAME_DEVICE(k_cache, v_cache, k, v, offsets, past_kv_lengths, cache_ids);
    ...
    func(k_cache, v_cache, k, v, offsets, past_kv_lengths, cache_ids);
}
...
Tensor kv_caching(Tensor k_cache,
                  ...
                  Tensor past_kv_lengths,
                  Tensor cache_ids) {
    KVCaching::execute(k_cache, v_cache, k, v, offsets, past_kv_lengths, cache_ids);
