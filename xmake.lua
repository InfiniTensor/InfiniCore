...
target("infinirt")
    ...
    if has_config("nv-gpu") then
        ...
        add_files("build/.objs/infinirt-nvidia/rules/dlcc.cuda/src/infinirt/cuda/infinirt_cuda.cu.o", {public = true})
    end
    if has_config("cambricon-mlu") then
...
target("infiniop")
    ...
    if has_config("nv-gpu") then
        ...
        add_files("build/.objs/infiniop-nvidia/rules/dlcc.cuda/src/infiniop/ops/*/nvidia/*.cu.o", {public = true})
        add_files("build/.objs/infiniop-nvidia/rules/dlcc.cuda/src/infiniop/devices/nvidia/*.cu.o", {public = true})
    end
    if has_config("iluvatar-gpu") then
