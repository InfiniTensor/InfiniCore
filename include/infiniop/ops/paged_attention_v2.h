#ifndef __INFINIOP_PAGED_ATTENTION_V2_API_H__
#define __INFINIOP_PAGED_ATTENTION_V2_API_H__

#include "../operator_descriptor.h"
#include <stdint.h>

typedef struct InfiniopDescriptor *infiniopPagedAttentionV2Descriptor_t;

__C __export infiniStatus_t infiniopCreatePagedAttentionV2Descriptor(
...
__C __export infiniStatus_t infiniopGetPagedAttentionV2WorkspaceSize(
    infiniopPagedAttentionV2Descriptor_t desc, size_t *size);

__C __export infiniStatus_t infiniopPagedAttentionV2(
...
__C __export infiniStatus_t infiniopDestroyPagedAttentionV2Descriptor(
    infiniopPagedAttentionV2Descriptor_t desc);
