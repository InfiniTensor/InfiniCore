...
def parse_test_cases():
    ...
    """
    test_cases = []
    for num_seqs, num_heads, num_kv_heads, head_size, block_size, max_seq_len, use_alibi in _TEST_CASES_DATA:
        ...
        seq_lens_torch = torch.randint(
            1, 1024, (num_seqs,), dtype=torch.int32
        )
        ...
        for dtype in _TENSOR_DTYPES:
            ...
            block_tables_spec = TensorSpec.from_tensor(block_tables_shape,init_mode=TensorInitializer.MANUAL, set_tensor=block_tables,dtype=infinicore.int32)
            seq_lens_spec = TensorSpec.from_tensor(seq_lens_shape,init_mode=TensorInitializer.MANUAL, set_tensor=seq_lens_torch,dtype=infinicore.int32)
            ...
            test_cases.append(
                TestCase(
                    inputs=[q_spec, k_cache_spec, v_cache_spec, block_tables_spec, seq_lens_spec],
...
class OpTest(BaseOperatorTest):
    ...
    def infinicore_operator(self, *args, **kwargs):
        ...
        return infinicore.paged_attention(*args, **kwargs)
