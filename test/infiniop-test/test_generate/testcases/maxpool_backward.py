...
class MaxPoolBackwardTestCase(InfiniopTestCase):
    ...
    def write_test(self, test_writer: "InfiniopTestWriter"):
        ...
        test_writer.add_bool(
            test_writer.gguf_key("return_indices"), self.return_indices
        )

        # Add indices if return_indices is True
...
if __name__ == "__main__":
    ...
    for dtype in dtypes:
        ...
        # Cases with return_indices=True
        test_cases.extend(
            [
                MaxPoolBackwardTestCase(
                    input_size=(2, 3, 48),
    ...
    print(f"Cases with indices: {sum(1 for tc in test_cases if tc.return_indices)}")
