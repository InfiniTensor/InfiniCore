...
from libinfiniop import (
    get_test_devices as _get_test_devices,
)
from libinfiniop import (
    test_operator as _test_operator,
)
...
def get_test_devices(args):
    return _get_test_devices(args)


def test_operator(device, test_func, test_cases, dtypes):
    return _test_operator(device, test_func, test_cases, dtypes)
